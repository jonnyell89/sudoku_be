...
public class SudokuGrid {
    ...
    public SudokuGrid() {
        ...
        for (int i = 0; i < this.grid.length; i++) { // Iterate over rows.
    ...
    public int[] getCol(int colIndex) {
        ...
        int[] gridColumn = new int[this.grid.length]; // Instantiate array of specific length.

        for (int i = 0; i < this.grid.length; i++) { // Iterate over rows.

            gridColumn[i] = this.grid[i][colIndex]; // Set array element equal to specific cell.
        }
